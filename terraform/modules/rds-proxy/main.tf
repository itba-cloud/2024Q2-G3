# Este módulo NO fue creado por nosotros, es un módulo de la comunidad de Terraform.
# Lo modificamos para que soporte lifecycle y no tarde tanto en recrear el recurso.
# Créditos: https://github.com/terraform-aws-modules/terraform-aws-rds-proxy
